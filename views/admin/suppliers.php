...
<body class="bg-gray-100 font-sans flex min-h-screen flex-col">
    ...
    <main class="container mx-auto p-6 flex-grow">
        <h1 class="text-4xl font-bold mb-6">Manajemen Pemasok</h1>
            ...
            <table class="min-w-full table-auto border">
                <thead class="bg-gray-200 text-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-2">Nama Perusahaan</th> <th class="px-4 py-2">Nama Kontak</th> <th class="px-4 py-2">Email</th>
