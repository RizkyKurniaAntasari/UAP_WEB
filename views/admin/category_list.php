<?php
// UAP_WEB/views/admin/category_list.php
// Variabel seperti $page_title, $categories, $messages diekspor dari controller.
...
<body>
    ...
    <div class="container">
        ...
        <p><a href="<?php echo $script_name; ?>/admin/categories/add" class="button button-primary">Tambah Kategori Baru</a></p>
                    ...
                    <?php foreach ($categories as $category): ?>
                        <tr>
                            ...
                            <td class="action-links">
                                <a href="<?php echo $script_name; ?>/admin/categories/edit/<?php echo $category['id']; ?>">Edit</a> |
                                <a href="<?php echo $script_name; ?>/admin/categories/delete/<?php echo $category['id']; ?>" onclick="return confirm('Anda yakin ingin menghapus kategori ini?');">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
